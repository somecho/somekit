...
return html_coll.item(p1__20622_SHARP_);
...
return cljs.core.some((function (p1__20625_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__20625_SHARP_);
...
var ctx_20653 = cvs.getContext("2d");
(ctx_20653.fillStyle = color);

ctx_20653.fillRect((0),(0),size,size);

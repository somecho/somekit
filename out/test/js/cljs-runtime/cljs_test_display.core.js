...
var node = (function (){var G__20773 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__20774 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__20775 = style_string_20996;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__20773,G__20774,G__20775) : cljs_test_display.core.n.call(null,G__20773,G__20774,G__20775));
})();
...
var len__5769__auto___20997 = arguments.length;
var i__5770__auto___20998 = (0);
while(true){
if((i__5770__auto___20998 < len__5769__auto___20997)){
args__5775__auto__.push((arguments[i__5770__auto___20998]));

var G__20999 = (i__5770__auto___20998 + (1));
i__5770__auto___20998 = G__20999;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq20779){
var G__20781 = cljs.core.first(seq20779);
var seq20779__$1 = cljs.core.next(seq20779);
var G__20783 = cljs.core.first(seq20779__$1);
var seq20779__$2 = cljs.core.next(seq20779__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20781,G__20783,seq20779__$2);
}));
...
var vec__20807 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20807,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20807,(1),null);
var G__20810 = cljs.core.PersistentArrayMap.EMPTY;
var G__20810__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20810,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20810);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20810__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__20810__$1;
}
} else {
...
return (function() { 
var G__21007__delegate = function (klass,contents){
var vec__20833 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20833,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20833,(1),null);
...
var G__21007 = function (klass,var_args){
var contents = null;
...
while (G__21009__i < G__21009__a.length) {G__21009__a[G__21009__i] = arguments[G__21009__i + 1]; ++G__21009__i;}
  contents = new cljs.core.IndexedSeq(G__21009__a,0,null);
} 
return G__21007__delegate.call(this,klass,contents);};
G__21007.cljs$lang$maxFixedArity = 1;
G__21007.cljs$lang$applyTo = (function (arglist__21010){
var klass = cljs.core.first(arglist__21010);
var contents = cljs.core.rest(arglist__21010);
return G__21007__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__20852){
var map__20853 = p__20852;
var map__20853__$1 = cljs.core.__destructure_map(map__20853);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20853__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__20866){
var map__20867 = p__20866;
var map__20867__$1 = cljs.core.__destructure_map(map__20867);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20867__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20867__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__20873){
var map__20874 = p__20873;
var map__20874__$1 = cljs.core.__destructure_map(map__20874);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20874__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20874__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__20887_SHARP_){
return cljs.core.cons(new_current_node,p1__20887_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__20892 = cljs_test_display.core.current_var_info();
var map__20892__$1 = cljs.core.__destructure_map(map__20892);
var info = map__20892__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20892__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20892__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20892__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__20889_SHARP_){
return cljs.core.cons(node,p1__20889_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__20896){
var map__20897 = p__20896;
var map__20897__$1 = cljs.core.__destructure_map(map__20897);
var m = map__20897__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20897__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20897__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20897__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20897__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__20925 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__20925) : formatter_fn.call(null,G__20925));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__20926 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__20926) : formatter_fn.call(null,G__20926));
})()], 0));
});
...
var temp__5804__auto___21024 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___21024)){
var message_21025 = temp__5804__auto___21024;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_21025], 0));
} else {
}
...
var temp__5804__auto___21027 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___21027)){
var message_21028 = temp__5804__auto___21027;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_21028], 0));
} else {
}

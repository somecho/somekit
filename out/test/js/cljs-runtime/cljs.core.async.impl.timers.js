...
var i_13476 = (self__.level + (1));
while(true){
if((i_13476 <= (new_level + (1)))){
(update[i_13476] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13479 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13479[i]));
} else {
x__$2.forward.push((((i < links_13479.length))?(links_13479[i]):null));
}

if((i < links_13479.length)){
(links_13479[i] = x__$2);
} else {
links_13479.push(x__$2);
}
...
var links_13489 = (update[i_13487]).forward;
if((x__$1 === (((i_13487 < links_13489.length))?(links_13489[i_13487]):null))){
(links_13489[i_13487] = (x__$1.forward[i_13487]));
...
if(cljs.core.truth_(nx)){
var G__13504 = nx;
var G__13505 = (level__$1 - (1));
x = G__13504;
level__$1 = G__13505;
continue;
} else {
var G__13506 = x;
var G__13507 = (level__$1 - (1));
x = G__13506;
level__$1 = G__13507;
continue;
}
